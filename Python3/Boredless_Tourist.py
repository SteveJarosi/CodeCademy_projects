...
def get_attractions_for_traveler(traveler):
    ...
    interest_string = "Hi {}, we think you'll like these places around {}: ".format(traveler[0], traveler[1])
    for i in traveler_attractions:
        interest_string+= i + ", "
    return interest_string[:-2]+"!"

print(get_attractions_for_traveler(['John', 'Los Angeles, USA', ['art']]))
